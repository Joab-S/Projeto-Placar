    ...
    case 1:
      while(1){
          if(analogRead(A1) <= parameter){ 
            ...
            delay(1000);          //adicionado pra teste
            Serial.println(1000); //adicionado pra teste
    ...
    case 2:
      while(1){
       if(analogRead(A2) <= parameter){ 
          ...
          delay(2000);          //adicionado pra teste
          Serial.println(2000); //adicionado pra teste
    ...
    //case 4:
      ...
      while(1){
        ...
        if(analogRead(A0) <= parameter){
          ...
          delay(3000);          //adicionado pra teste
          Serial.println(3000); //adicionado pra teste
